...
class StatusSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $coreStatuses = [
            ...
            ['name' => 'Awarding', 'bg_color' => '#dcfce7', 'text_color' => '#166534', 'sort_order' => 7, 'is_active' => true],
            ...
            ['name' => 'Dibatalkan', 'bg_color' => '#fee2e2', 'text_color' => '#991b1b', 'sort_order' => 10, 'is_active' => true],
        ];
        ...
        $legacyStatuses = [
            ...
            ['name' => 'PR Dibatalkan', 'bg_color' => '#fee2e2', 'text_color' => '#991b1b', 'sort_order' => 112, 'is_active' => false],
            ['name' => 'PO dibatalkan', 'bg_color' => '#fee2e2', 'text_color' => '#991b1b', 'sort_order' => 113, 'is_active' => false],
            ['name' => 'PR dikembalikan ke PPP untuk di proses di PI', 'bg_color' => '#fee2e2', 'text_color' => '#991b1b', 'sort_order' => 114, 'is_active' => false],
            ['name' => 'Draft', 'bg_color' => '#f1f5f9', 'text_color' => '#334155', 'sort_order' => 115, 'is_active' => false],
            ['name' => 'Pending', 'bg_color' => '#fef9c3', 'text_color' => '#854d0e', 'sort_order' => 116, 'is_active' => false],
            ['name' => 'Approved', 'bg_color' => '#dcfce7', 'text_color' => '#166534', 'sort_order' => 117, 'is_active' => false],
            ['name' => 'Rejected', 'bg_color' => '#fee2e2', 'text_color' => '#991b1b', 'sort_order' => 118, 'is_active' => false],
        ];
